...
/**
 *
 * Note: LICENSE.txt has been renamed to LICENSE.tinymt32.txt
 * to avoid confusion. There might be some modifications to the
 * original source by the authors, but I can't remember
 * them at the moment.
 *
 */
